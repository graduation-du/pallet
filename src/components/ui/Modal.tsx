      ...
      {open ? (
        <div className="fixed inset-0 z-[80] flex items-end justify-center p-3 sm:items-center sm:p-6">
          ...
          <motion.div
            ...
            className={`relative z-[1] w-full ${maxW} overflow-hidden rounded-[1.5rem] bg-white shadow-2xl shadow-navy-950/25 ring-1 ring-slate-200/80`}
          >
            <div className="relative overflow-hidden border-b border-line bg-gradient-to-br from-navy-950 via-blue-900 to-blue-700 px-5 py-4 text-white">
              ...
              <div className="relative flex items-start justify-between gap-3">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-white/10 text-white ring-1 ring-white/15 transition hover:bg-white/20"
                >
                  <X size={18} />
                </button>
              </div>
